...
echo "   • Management-Tool: sudo ./scripts/manage_fotobox.sh"
echo "   • Kamera-Diagnose: ./scripts/manage_fotobox.sh --diagnose"
echo "   • Probleme beheben: sudo ./scripts/manage_fotobox.sh --fix-usb"
echo "   • Service-Logs: sudo journalctl -u photobox -f"
echo "   • System-Status: ./scripts/manage_fotobox.sh --status"
